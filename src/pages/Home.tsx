  ...
  return (
    <>
      ...
      <section className='hidden md:hidden bg-[#101010]  grid-cols-1 md:grid-cols-1 lg:grid-cols-4  lg:grid gap-2 '>
        <div className='pt-60 lg:pl-32 p-9 md:pt-48 md:p-32  pb-40 col-span-2 flex flex-col items-center justify-center lg:block'>
            ...
            <Link to="/product/2" className='bg-[#D87D4A] px-7 py-3 text-white text-[13px] font-bold hover:bg-[#FBAF85] duration-200 tracking-[1px] cursor-pointer'>SEE PRODUCT</button>
        </div>
